...
const char* password = "M79<oX{yrM"; // Replace with your network password
#define DATABASE_URL "https://xiaoesp32-firebase-default-rtdb.firebaseio.com/" // Replace with your database URL
#define API_KEY "AIzaSyDHIc2djYYucOmp3JCWwjxJHdWjXx7uiE4" // Replace with your API key
